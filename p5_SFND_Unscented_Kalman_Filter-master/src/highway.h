...
public:
	...
	std::vector<bool> trackCars = {true,true,true}; // can be used to toggle on/off cars for the UKF objects to track
	// Visualize sensor measurements
	bool visualize_lidar = true;
	bool visualize_radar = true;
	bool visualize_pcd = false; //Lidar pointcloud
	// Predict path in the future using UKF
	double projectedTime = 0; // predicted position for the car in the future over a 2 second interval.
	int projectedSteps = 0; // The number of steps increases the number of positions to interpolate the time interval.
	// --------------------------------
